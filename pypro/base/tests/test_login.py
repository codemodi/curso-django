...
def test_botao_link_entrar_disponivel(resp_home):
...
def test_botao_entrar_indisponivel(resp_com_usuario_logado):
    assert_not_contains(resp_com_usuario_logado, 'Entrar')
...
def test_botao_sair_disponivel(resp_com_usuario_logado):
...
def test_link_de_logout_disponivel(resp_com_usuario_logado):
